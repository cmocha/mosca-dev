...
Using Nunjucks for html templates.

## Operations

- run npx eleventy --serve in project folder to start local dev.
- run git push origin master to push to remote repo.
- run git push live master to push to server. See the post.receive git hook on the server for details on what is triggered. /repo/mosca.git/hooks/
...
## Reference to original README below:
